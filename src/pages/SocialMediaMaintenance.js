        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-primary-400 mb-8 max-w-2xl mx-auto font-medium leading-relaxed">
              Keep the profiles active and on-brand — scheduling, replies, and
              a simple read on what&apos;s working.
            </p>
        ...
        items={[
          {
            ...
            to: '/social-media',
            description:
              'Full management when you want posting, reviews, and reporting handled.',
          },
          {
            title: 'Content Creation',
            to: '/content-creation',
            description: 'Fresh posts and creative so the feed does not stall.',
          },
          {
            title: 'Web Design & SEO',
            to: '/web-design-seo',
            description: 'Send social traffic to a site built to book the job.',
          },
        ]}
      />
