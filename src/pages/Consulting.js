      ...
      <div className="bg-mint py-8 border-b border-primary-100">
        <div className="container mx-auto px-4 max-w-3xl text-center">
          <p className="text-primary-600 text-base md:text-lg font-semibold leading-relaxed">
            We build our own software too — Nexus and NightSync are live
        ...
        items={[
          {
            ...
            to: '/web-design-seo',
            description:
              'The public site that feeds your app, bookings, and lead flow.',
          },
          {
            title: 'Social Media Management',
            to: '/social-media',
            description: 'Audience and reviews that pair with a custom tool.',
          },
          {
            title: 'Content Creation',
            to: '/content-creation',
            description: 'Copy and creative for the product, site, and social.',
          },
        ]}
      />
      ...
      <div className="bg-ink py-16 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative">
          <p className="text-xl md:text-2xl text-white font-medium mb-8">
            Have an idea, or a process that should be software?
          </p>
